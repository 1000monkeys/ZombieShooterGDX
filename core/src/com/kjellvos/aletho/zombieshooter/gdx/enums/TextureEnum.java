...
public enum TextureEnum {
    ...
    BRONZE_SWORD(9, true, false, "A crude bronze sword.", 1F, 1.5F, 0, Constants.PPM / 2),
    HYBRID_SWORD(10, true, false, "A sword crudely made out of iron and bronze.", 1F, 1.5F, 0, Constants.PPM / 2),
    IRON_SWORD(11, true, false, "An iron sword, seems pretty sharp.", 1F, 1.5F, 0, Constants.PPM / 2),
    IRON_GEM_SWORD(12, true, false, "An iron sword, Has a gem on the hilt.", 1F, 1.5F, 0, Constants.PPM / 2),
    IRON_BROAD_SWORD(13, true, false, "An board sword.", 1F, 1.5F, 0, Constants.PPM / 3),
    IRON_LONG_SWORD(14, true, false, "AN iron long sword, It has pretty good reach.", 1F, 2F, 0, 0),
    IRON_HAMMER(15, true, false, "A long iron hammer, has very good reach.", 1F, 3F, 0, 0),
    IRON_SHORT_SWORD(71, true, false, "An iron short sword, You could really do some damage with this", 1F, 1.5F, 0, Constants.PPM / 2),
    IRON_CLEAVER(72, true, false, "An iron cleaver, it is heavy.", 1F, 1.5F, 0, Constants.PPM / 2),
    GOLD_SHORT_SWORD(73, true, false, "A very pretty gold short sword.", 1F, 1.5F, 0, Constants.PPM / 2),
    ...
    LIGHT_ANIMATION_0(296, false, false, "Top of the fire, Very hot!", 1F, 1.5F, 0, Constants.PPM / 2),
    LIGHT_ANIMATION_1(297, false, false, "Top of the fire, Very hot!", 1F, 1.5F,0, Constants.PPM / 2),
    LIGHT_ANIMATION_2(298, false, false, "Top of the fire, Very hot!", 1F, 1.5F,0, Constants.PPM / 2),
    LIGHT_ANIMATION_3(299, false, false, "Top of the fire, Very hot!", 1F, 1.5F,0, Constants.PPM / 2),
    LIGHT_ANIMATION_4(300, false, false, "Top of the fire, Very hot!", 1F, 1.5F,0, Constants.PPM / 2),
    LIGHT_ANIMATION_5(301, false, false, "Top of the fire, Very hot!", 1F, 1.5F,0, Constants.PPM / 2),
    LIGHT_ANIMATION_6(302, false, false, "Top of the fire, Very hot!", 1F, 1.5F,0, Constants.PPM / 2),
    LIGHT_ANIMATION_7(303, false, false, "Top of the fire, Very hot!", 1F, 1.5F,0, Constants.PPM / 2),
